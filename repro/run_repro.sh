...
mkdir -p .tmp/anabelian_hyperbolicity
cp artifacts/stitch_constants.json .tmp/anabelian_hyperbolicity/stitch_constants.json
cp artifacts/constants_registry.json .tmp/anabelian_hyperbolicity/constants_registry.json
