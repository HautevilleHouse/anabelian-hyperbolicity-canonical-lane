...
mkdir -p .repro_tmp/anabelian_hyperbolicity
cp artifacts/stitch_constants.json .repro_tmp/anabelian_hyperbolicity/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/anabelian_hyperbolicity/constants_registry.json
